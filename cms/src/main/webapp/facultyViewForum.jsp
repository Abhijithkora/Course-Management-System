...
<body>
<a href="facultyHome.jsp" style="text-align:center;text-decoration: none;color:blue;border: 1px;padding:20px;border-radius:10px;">
    Back To Home
</a>
<div class="container mt-4">
    ...
    <table class="table table-hover">
        ...
        <tr>
            <td>
                <button class="btn btn-primary btn-sm" onclick="openReplyModal('<%= id %>', '<%= senderName %>', '<%= subject %>')">Reply</button>
                <button class="btn btn-warning btn-sm" onclick="openEditModal('<%= id %>', '<%= senderName %>', '<%= subject %>', '<%= message %>')">Edit</button>
                <button class="btn btn-danger btn-sm" onclick="deleteMessage('<%= id %>')">Delete</button>
            </td>
            <td><%= senderName %></td>
            <td><%= subject %></td>
            ...
            <div class="modal-body">
                <form id="replyForm" action="fpostReply.jsp" method="post">
                    ...
                    <div class="form-group">
                        <label for="replySenderName">Your Name</label>
                        <input type="text" class="form-control" id="replySenderName" name="senderName" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form id="editForm" action="fupdateForum.jsp" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="editSenderName" name="senderName" readonly>
                    </div>
                    <div class="form-group">
