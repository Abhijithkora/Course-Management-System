	...
	<div class="container">
		...
		<div class="left">
			...
			<div class="menu">
				...
				<div class="option">
					<div class="icon">
						<a href="courseSelection.jsp" class="option-anchor"> 
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							width="24" height="24" color="#000000" fill="none">
                            <path
						...
						<div class="hometext">My courses</div>
						</a>
				...
				<div class="option">
					<div class="icon">
						 <a href="viewAssignment.jsp" class="option-anchor"> 
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							width="24" height="24" color="#000000" fill="none">
                            <path
						...
						<div class="hometext">Assignment</div>
						 </a>
				...
				<div class="option">
					<div class="icon">
						...
						<div class="hometext">Time table</div>
						 </a> 
 ...
 %></b>
				...
				<div class="row" style="margin-top: 70px;">
					<div class="col-lg-3 text-center">
						<div class="figurerall"
							style="position: relative; min-height: 1px; padding-right: 15px; padding-left: 15px;">
							<div class="figureicon">
								<img
									src="https://newerp.kluniversity.in/images/icons/jouranl.png"
									style="width: 50px; height: 50px; color: red; margin-top: 15px;">
								<div
									style="font-size: 15px; color: #a51c24; font-weight: bolder"
									class="count" data-to="0" data-speed="1500">0</div>
							</div>
							<div class="figuretitle text-center">
								<h4>
									<a href="#" style="text-decoration: none;">Journals &amp; Conferences</a>
								</h4>
							</div>
						</div>
					</div>
					<div class="col-lg-3 text-center ">
						<div class="figurerall">
							<div class="figureicon">
								<img
									src="https://newerp.kluniversity.in/images/icons/awards.png"
									style="width: 50px; height: 50px; color: red; margin-top: 15px;">
								<div
									style="font-size: 15px; color: #a51c24; font-weight: bolder"
									class="count" data-to="0" data-speed="1500">0</div>
							...
							<div class="figuretitle text-center">
								<h4>
									<a href="#" style="text-decoration: none;">Awards &amp; Recognitions</a>
								</h4>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-3 text-center">
						<div class="figurerall">
							<div class="figureicon">
								<img
                  src="https://newerp.kluniversity.in/images/icons/guest-lectures.png"
                  style="width: 50px; height: 50px; color: red; margin-top: 15px;">	<div
									style="font-size: 15px; color: #a51c24; font-weight: bolder"
									class="count" data-to="0" data-speed="1500">0</div>
							</div>
							<div class="figuretitle text-center">
								<h4>
									<a href="#" style="text-decoration: none;">Workshops, Seminars &amp; Guest Lectures</a>
								</h4>
							</div>
						</div>
					</div>
					<div class="col-lg-3 text-center row">
						<div class="figurerall">
							<div class="figureicon">
								<img src="https://newerp.kluniversity.in/images/icons/projects.png"
                  style="width: 50px; height: 50px; color: red; margin-top: 15px;">
								<div
									style="font-size: 15px; color: #a51c24; font-weight: bolder"
									class="count" data-to="0" data-speed="1500">0</div>
							...
							<div class="figuretitle text-center">
								<h4>
									<a href="#" style="text-decoration: none;">Projects &amp; Consultancy</a>
								</h4>
							</div>
						</div>
					</div>
